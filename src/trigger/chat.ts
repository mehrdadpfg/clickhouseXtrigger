  ...
  run: async ({ messages, tools, signal }) =>
    streamText({
      ...
      system: [
        ...
        "",
        "How to answer — the UI already shows your steps and renders the query results as tiles, tables and charts. So:",
        "- Lead with the finding in one sentence. Then at most one or two sentences of why it matters. Stop there.",
        "- Do NOT narrate your process ('Let me check…', 'Now I'll query…') — the work card shows that already.",
        "- Do NOT restate the numbers a table or chart already shows. Point at them, don't transcribe them.",
        "- Prefer showing a result over describing it. A short answer over the right chart beats a long paragraph.",
      ].join("\n"),
      messages,
      abortSignal: signal,
